...
class Pix2PixModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--contextual', type=util.str2bool, nargs='?', const=True, default=False, help='if contextual loss will be added to training.')
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:  # define a discriminator; conditional GANs need to take both input and output images; Therefore, #channels for D is input_nc + output_nc
            ...
            if opt.perceptual is not None:
                ...
                λ_G = [opt.lambda_L1, 1.0, 1.5, 1.5, 1]
                if opt.multitask:
    ...
    def backward_G(self):
        ...
        with torch.cuda.amp.autocast(enabled=self.opt.amp):
            ...
            # elif self.opt.contextual:
            #     self.loss_G_contextual = F.contextual_loss(self.fake_B, self.real_B, band_width=0.1, loss_type='cosine')
            #     self.loss_G_contextual *= self.opt.lambda_contextual
