...
class BaseModel(ABC):
    ...
    def set_input(self, input):
        ...
        # print("---------debug info from Base Model ---------------")
        # print('real_A shape: ', np.shape(self.real_A))
        # print('real_B shape: ', np.shape(self.real_B))
        # print('A_paths ', input['A_paths'])
        # print('B_paths ', input['B_paths'])
        # Applying padding for real_A and real_B
        # print(np.shape(self.real_A[0, 0, :, :, :,]))
        # print(np.shape(self.real_A[0, 1, :, :, :,]))
        # print(np.shape(self.real_B[0, 0, :, :, :,]))
